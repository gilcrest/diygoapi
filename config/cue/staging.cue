...
config: gcp: artifactoryRegistry: repoLocation: "us-central1"
config: gcp: artifactoryRegistry: repoName:     "diy-go-api-docker-repo"
config: gcp: artifactoryRegistry: imageID:      "staging"
config: gcp: artifactoryRegistry: tag:          "latest"
