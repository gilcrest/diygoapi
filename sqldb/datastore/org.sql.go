...
func (q *Queries) DeleteOrg(ctx context.Context, orgID pgtype.UUID) (int64, error) {
...
func (q *Queries) FindOrgByID(ctx context.Context, orgID pgtype.UUID) (FindOrgByIDRow, error) {
...
func (q *Queries) FindOrgByIDWithAudit(ctx context.Context, orgID pgtype.UUID) (FindOrgByIDWithAuditRow, error) {
