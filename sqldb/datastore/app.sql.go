...
func (q *Queries) DeleteApp(ctx context.Context, appID pgtype.UUID) (int64, error) {
...
func (q *Queries) DeleteAppAPIKeys(ctx context.Context, appID pgtype.UUID) (int64, error) {
...
func (q *Queries) FindAPIKeysByAppID(ctx context.Context, appID pgtype.UUID) ([]AppApiKey, error) {
...
type FindAppByExternalIDWithAuditRow struct {
	...
	AppDescription       string
	CreateAppID          pgtype.UUID
	CreateAppOrgID       pgtype.UUID
	CreateAppExtlID      string
	CreateAppName        string
	CreateAppDescription string
	CreateUserID         pgtype.UUID
	CreateUserFirstName  pgtype.Text
	CreateUserLastName   pgtype.Text
	CreateTimestamp      pgtype.Timestamptz
	UpdateAppID          pgtype.UUID
	UpdateAppOrgID       pgtype.UUID
	UpdateAppExtlID      string
	UpdateAppName        string
	UpdateAppDescription string
	UpdateUserID         pgtype.UUID
	UpdateUserFirstName  pgtype.Text
	UpdateUserLastName   pgtype.Text
	UpdateTimestamp      pgtype.Timestamptz
}
...
func (q *Queries) FindAppByID(ctx context.Context, appID pgtype.UUID) (FindAppByIDRow, error) {
...
func (q *Queries) FindAppByIDWithAudit(ctx context.Context, appID pgtype.UUID) (FindAppByIDWithAuditRow, error) {
...
func (q *Queries) FindAppByProviderClientID(ctx context.Context, authProviderClientID pgtype.Text) (FindAppByProviderClientIDRow, error) {
...
func (q *Queries) FindAppsByOrg(ctx context.Context, orgID pgtype.UUID) ([]App, error) {
