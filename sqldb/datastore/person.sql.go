...
func (q *Queries) DeletePerson(ctx context.Context, personID pgtype.UUID) (int64, error) {
...
func (q *Queries) DeleteUserByID(ctx context.Context, userID pgtype.UUID) (int64, error) {
...
func (q *Queries) DeleteUserLanguagePreferences(ctx context.Context, userID pgtype.UUID) (int64, error) {
...
func (q *Queries) FindPersonByUserID(ctx context.Context, userID pgtype.UUID) (FindPersonByUserIDRow, error) {
...
func (q *Queries) FindUserLanguagePreferencesByUserID(ctx context.Context, userID pgtype.UUID) ([]UsersLangPref, error) {
