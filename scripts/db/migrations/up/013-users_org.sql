...
(
    ...
    constraint users_org_pk
        primary key (users_org_id),
    constraint users_org_org_id_fk
        foreign key (org_id) references org
            deferrable initially deferred,
    constraint users_org_user_id_fk
        foreign key (user_id) references users
            deferrable initially deferred,
    constraint users_org_create_app_fk
        foreign key (create_app_id) references app
            deferrable initially deferred,
    constraint users_org_create_user_fk
        foreign key (create_user_id) references users
            deferrable initially deferred,
    constraint users_org_update_app_fk
        foreign key (update_app_id) references app
            deferrable initially deferred,
    constraint users_org_update_user_fk
